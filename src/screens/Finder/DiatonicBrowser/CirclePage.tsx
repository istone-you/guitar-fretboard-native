...
export interface DiatonicCirclePageProps {
  theme: Theme;
...
export default function DiatonicCirclePage({
  rootSemitone,
  initialKeyType,
  ...rest
}: DiatonicCirclePageProps) {
  ...
  const [activeOverlay, setActiveOverlay] = useState<CircleOverlayKey | null>("diatonic");
